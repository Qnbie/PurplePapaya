...
public class AuthService {
    ...
    private void fetchUserAndEnable(VerificationToken verificationToken) throws PurplePapayaException {
    ...
    public void verifyAccount(String token) throws PurplePapayaException {
        ...
        fetchUserAndEnable(verificationToken.orElseThrow(() -> new PurplePapayaException("Invalid Token")));
    }
    ...
    public AuthenticationResponse refreshToken(RefreshTokenRequest refreshTokenRequest) throws PurplePapayaException {
